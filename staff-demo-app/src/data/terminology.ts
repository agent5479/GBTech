...
import {
  SHOWCASE_STAFF_APP_NAME,
  SHOWCASE_STAFF_TAGLINE,
} from '@shared/showcaseBrand';

const liveLabels = {
  appName: 'Hub Staff',
  appTagline: 'Facility hire CRM',
  ...
  bookingImportHint: 'Review confirmed website bookings — import into renter records or dismiss.',
...
export const labels = {
  ...
  ...(IS_SHOWCASE_MODE
    ? {
        appName: SHOWCASE_STAFF_APP_NAME,
        appTagline: SHOWCASE_STAFF_TAGLINE,
        bookingBrief: 'Booking summary',
        activityLog: 'Activity Log',
        activityLogHint: 'Review staff changes across imports and renter records.',
      }
    : {}),
};
