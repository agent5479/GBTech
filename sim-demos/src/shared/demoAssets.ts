...
export const DEMO_META: Record<DemoImageId, { title: string; alt: string }> = {
  ...
  harbourbook: { title: 'Harbour Book', alt: 'Empty community hall hire room with tables and chairs' },
  hallboard: { title: 'Hall Board', alt: 'Venue staff reviewing a room timetable on a whiteboard' },
  hiverun: { title: 'Hive Run', alt: 'Apiarist lifting a honeycomb frame from a hive in a paddock' },
  apiary: { title: 'Apiary Board', alt: 'Beekeepers planning yard runs beside clusters of hives' },
  carevisit: { title: 'Care Visit', alt: 'Carer sitting with an older person during a home visit' },
  rounds: { title: 'Round Board', alt: 'Care staff reviewing a printed day roster in the office' },
}
