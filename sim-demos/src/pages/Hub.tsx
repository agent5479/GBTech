    ...
    demos: [
      {
        ...
        blurb: 'Client floor plan — tap a room tile, hire window, extras. Not a generic wizard.',
    ...
    demos: [
      {
        ...
        look: 'Honey · charcoal',
        blurb: 'Map of clusters + phone log — Common/All tasks by category, yard flags. No public clients.',
      ...
      },
      {
        ...
        look: 'Wax · forest',
        blurb: 'KPI strip, cluster map, week grid of staff by yard — management ops, not a wizard.',
    ...
    demos: [
      {
        ...
        look: 'Sky · soft slate',
        blurb: 'Household map + phone visit log — meds due, grouped care ticks, hand-off.',
      ...
      },
      {
        ...
        look: 'Navy · coral',
        blurb: 'Carers × visit windows — coverage gaps, reassign, covered ticks.',
