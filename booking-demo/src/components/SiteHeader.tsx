    ...
    >
      <div className="site-header__inner">
        ...
        <div className="site-header__actions">
          ...
          <NavLink to={BOOK_CTA.to} className="site-header__cta" onClick={close}>
            {BOOK_CTA.label}
          </NavLink>
          <button
      ...
      <nav className="site-nav" id="site-nav" aria-label="Main">
        <ul className="site-nav__list">
          {NAV_GROUPS.map((group) => (
            <li
              key={group.label}
              className={`site-nav__group${expandedGroup === group.label ? ' is-expanded' : ''}`}
            >
              <button
                type="button"
                className="site-nav__group-toggle"
                aria-expanded={expandedGroup === group.label}
                onClick={() => toggleGroup(group.label)}
              >
                {group.label}
              </button>
              <ul className="site-nav__sublist">
